...
//        setSupportActionBar(mToolbar);
        ...
        /* Google's Navigation Drawer */
//        mTitle = mDrawerTitle = getTitle();
//        mPlanetTitles = getResources().getStringArray(R.array.menu_titles_array);
//        mDrawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout);
...
//            String planet = getResources().getStringArray(R.array.menu_titles_array)[i];
//
